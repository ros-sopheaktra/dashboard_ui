...
{{-- BEGIN:: Role Edit Content --}}
@section('content')
    <div class="edit-role-content-wrapper mb-5">
        ...
        <form id="role-form" action="{{ route('role-update', ['id' => $role->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="general-info-wrapper">
                ...
                <div class="form-row align-items-end">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" minlength="2" maxlength="30" id="name" name="name" class="form-control" value="{{ $role->name }}" required>
                    </div>
                    ...
                    <tbody>
                        <tr> <!-- POS -->
                            ...
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-pos" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create pos">
                            ...
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                ...
                                <div class="custom-control custom-checkbox"> <!-- edit show receipt address -->
                        ...
                        <tr> <!-- Product -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-product" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view product">
                                    <label class="custom-control-label" for="view-product"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-product" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create product">
                                    <label class="custom-control-label" for="create-product"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-product" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit product">
                                    <label class="custom-control-label" for="edit-product"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-product" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete product">
                                    <label class="custom-control-label" for="delete-product"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox mr-2"> <!-- history -->
                                    <input type="checkbox" id="view-product-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view product_history">
                                    <label class="custom-control-label" for="view-product-history">History</label>
                                </div>
                                <div class="custom-control custom-checkbox"> <!-- detail -->
                                    <input type="checkbox" id="detail-product" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="detail product">
                        ...
                        <tr> <!-- Product variant -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-product_variant" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view product_variant">
                                    <label class="custom-control-label" for="view-product_variant"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-product_variant" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create product_variant">
                                    <label class="custom-control-label" for="create-product_variant"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-product_variant" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit product_variant">
                                    <label class="custom-control-label" for="edit-product_variant"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-product_variant" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete product_variant">
                                    <label class="custom-control-label" for="delete-product_variant"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox mr-2"> <!-- history -->
                                    <input type="checkbox" id="view-product_variant-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view product_variant_history">
                                    <label class="custom-control-label" for="view-product_variant-history">History</label>
                                </div>
                                <div class="custom-control custom-checkbox"> <!-- detail -->
                                    <input type="checkbox" id="detail-product_variant" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="detail product_variant">
                        ...
                        <tr> <!-- Payment Of Sale -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permissionCheckboxs" name="permissionsCheckbox[]" value="view sales_payment_options" id="view-sales-payment-options">
                                    <label class="custom-control-label" for="view-sales-payment-options"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permissionCheckboxs" name="permissionsCheckbox[]" value="create sales_payment_options" id="create-sales-payment-options">
                                    <label class="custom-control-label" for="create-sales-payment-options"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permissionCheckboxs" name="permissionsCheckbox[]" value="update sales_payment_options" id="update-sales-payment-options">
                                    <label class="custom-control-label" for="update-sales-payment-options"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input permissionCheckboxs" name="permissionsCheckbox[]" value="delete sales_payment_options" id="delete-sales-payment-options">
                                    <label class="custom-control-label" for="delete-sales-payment-options"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" class="custom-control-input permissionCheckboxs" name="permissionsCheckbox[]" value="view sales_payment_history" id="view-sales-payment-history">
                        ...
                        <tr> <!-- Customer -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-customer" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view customer">
                                    <label class="custom-control-label" for="view-customer"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-customer" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create customer">
                                    <label class="custom-control-label" for="create-customer"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-customer" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit customer">
                                    <label class="custom-control-label" for="edit-customer"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-customer" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete customer">
                                    <label class="custom-control-label" for="delete-customer"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-customer-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view customer_history">
                        ...
                        <tr> <!-- Category -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-category" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view category">
                                    <label class="custom-control-label" for="view-category"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-category" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create category">
                                    <label class="custom-control-label" for="create-category"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-category" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit category">
                                    <label class="custom-control-label" for="edit-category"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-category" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete category">
                                    <label class="custom-control-label" for="delete-category"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-category-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view category_history">
                        ...
                        <tr> <!-- Sub Category -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-subcategory" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view subcategory">
                                    <label class="custom-control-label" for="view-subcategory"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-subcategory" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create subcategory">
                                    <label class="custom-control-label" for="create-subcategory"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-subcategory" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit subcategory">
                                    <label class="custom-control-label" for="edit-subcategory"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-subcategory" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete subcategory">
                                    <label class="custom-control-label" for="delete-subcategory"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-subcategory-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view subcategory_history">
                        ...
                        <tr> <!-- Customer Group -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-customer-group" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view customer_group">
                                    <label class="custom-control-label" for="view-customer-group"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-customer-group" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create customer_group">
                                    <label class="custom-control-label" for="create-customer-group"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-customer-group" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit customer_group">
                                    <label class="custom-control-label" for="edit-customer-group"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-customer-group" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete customer_group">
                                    <label class="custom-control-label" for="delete-customer-group"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-customer-group-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view customer_group_history">
                        ...
                        <tr> <!-- Notification -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-notification" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view notification">
                            ...
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-notification" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit notification">
                        ...
                        <tr> <!-- District -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-district" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view district">
                                    <label class="custom-control-label" for="view-district"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-district" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create district">
                                    <label class="custom-control-label" for="create-district"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-district" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit district">
                                    <label class="custom-control-label" for="edit-district"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-district" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete district">
                                    <label class="custom-control-label" for="delete-district"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-district-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view district_history">
                        ...
                        <tr> <!-- Sangkat -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-sangkat" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view sangkat">
                                    <label class="custom-control-label" for="view-sangkat"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-sangkat" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create sangkat">
                                    <label class="custom-control-label" for="create-sangkat"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-sangkat" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit sangkat">
                                    <label class="custom-control-label" for="edit-sangkat"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-sangkat" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete sangkat">
                                    <label class="custom-control-label" for="delete-sangkat"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-sangkat-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view sangkat_history">
                        ...
                        <tr> <!-- System User -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-system-user" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view system_user">
                                    <label class="custom-control-label" for="view-system-user"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-system-user" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create system_user">
                                    <label class="custom-control-label" for="create-system-user"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-system-user" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit system_user">
                                    <label class="custom-control-label" for="edit-system-user"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-system-user" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete system_user">
                                    <label class="custom-control-label" for="delete-system-user"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-system-user-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view system_user_history">
                        ...
                        <tr> <!-- Role -->
                            ...
                            <td class="text-center"> <!-- view -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="view-role" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view role">
                                    <label class="custom-control-label" for="view-role"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- create -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="create-role" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="create role">
                                    <label class="custom-control-label" for="create-role"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- edit -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="edit-role" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="edit role">
                                    <label class="custom-control-label" for="edit-role"></label>
                                </div>
                            </td>
                            <td class="text-center"> <!-- delete -->
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" id="delete-role" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="delete role">
                                    <label class="custom-control-label" for="delete-role"></label>
                                </div>
                            </td>
                            <td class="d-flex flex-row flex-wrap"> <!-- miscellaneous -->
                                <div class="custom-control custom-checkbox"> <!-- history -->
                                    <input type="checkbox" id="view-role-history" name="permissionsCheckbox[]" class="custom-control-input permissionCheckboxs" value="view role_history">
            ...
            <div class="sales-btn-wrapper form-row mt-4">
                <input type="submit" class="btn btn-sm btn-outline-success mr-2" value="Update Role">
                <a class="btn btn-sm btn-outline-danger" href="{{ route('role-list') }}">Cancel</a>
            </div>
        </form>
    </div>
@endsection
{{-- END:: Role Edit Content --}}
